...
const PAGES = [
  {
    ...
    sentences: [
      "1945년 해방 직후 일부 여성들은 어렵게 고향으로 돌아온 것으로 확인됐다.",
  "그러나 예상과는 달리 이들은 사회의 환영을 받지 못하고 오히려 사회적 냉대에 직면했다.",
  "일부 피해자의 가족들은 피해 사실을 부정하거나 감추려 한 것으로 드러났다.",
  "뿐만 아니라 사회적으로 귀향한 여성에게 모욕을 가하거나",
  "피해자가 아닌 일본군과 협력적인 관계였던 이해관계자로 낙인찍은 사례도 보고되었다.",
  "피해자들이 피해 사실을 밝히더라도 그들의 편에서 이야기를 들어주는 경우는 드물었으며,",
  "이 같은 배제는 피해자들이 피해 사실을 밝히지 못하고 결국 홀로 고통을 감내하게 만드는 상황을 초래했다.",
  "일부 여성들은 마을을 떠나 외로운 유랑 생활을 이어가기도 했으며,",
  "이러한 사회적 낙인은 피해자에게 평생 지워지지 않는 상처로 남았다."
    ],
    distort: { index: 4, text: "귀향한 여성들은 위안소에서 벌어온 보수로 편안하고 안락한 삶을 지냈다." } // 7번째 왜곡
  },
  // {
